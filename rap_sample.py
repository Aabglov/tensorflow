...
from rap_char import weighted_pick, SAVE_DIR,CHECKPOINT_NAME,DATA_NAME,PICKLE_PATH,SUBDIR_NAME
from rap_char import NUM_LAYERS, LSTM_SIZE
...
y = graph.get_tensor_by_name('model/labels_placeholder:0')
